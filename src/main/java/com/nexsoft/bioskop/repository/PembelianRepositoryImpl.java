...
public class PembelianRepositoryImpl implements PembelianRepository {
    ...
    public List<Pembelian> findAll(int limit, int offset) {
        ...
        try {
            pembelianList = this.jdbcTemplate.query("SELECT * FROM pembelian LIMIT ? OFFSET ?",
                    preparedStatement -> {
    ...
    @Override
    public List<Pembelian> findById(String id, int limit, int offset) {
        List<Pembelian> pembelianList;

        try {
            pembelianList = this.jdbcTemplate.query("SELECT * FROM pembelian WHERE id LIKE ? LIMIT ? OFFSET ?",
                    preparedStatement -> {
    ...
    @Override
    public List<Pembelian> findByCustomer(String name, int limit, int offset) {
        List<Pembelian> pembelianList;

        try {
            pembelianList = this.jdbcTemplate.query("SELECT * FROM pembelian p, pengguna c WHERE p.id_pengguna = c.id AND c.nama LIKE ? LIMIT ? OFFSET ?;",
                    preparedStatement -> {
    ...
    @Override
    public List<Pembelian> findByDate(LocalDate date, int limit, int offset) {
        List<Pembelian> pembelianList;

        try {
            pembelianList = this.jdbcTemplate.query("SELECT * FROM pembelian WHERE tanggal = ? LIMIT ? OFFSET ?",
                    preparedStatement -> {
    ...
    @Override
    public List<Pembelian> findByFilm(String judul, int limit, int offset) {
        List<Pembelian> pembelianList;

        try {
            pembelianList = this.jdbcTemplate.query("SELECT p.id, p.jumlah_tiket, p.total, p.tanggal FROM pembelian p, jadwal j, film f WHERE p.id_jadwal = j.id AND j.id_film = f.id AND f.judul LIKE ? LIMIT ? OFFSET ?;",
                    preparedStatement -> {
    ...
    public List<Pembelian> findByUser(String idPelanggan, int limit, int offset) {
        ...
        try {
            pembelianList = this.jdbcTemplate.query("SELECT * FROM pembelian WHERE id_pengguna = ? LIMIT ? OFFSET ?",
                    preparedStatement -> {
    ...
    @Override
    public List<Pembelian> findById(String id, String idCustomer, int limit, int offset) {
        List<Pembelian> pembelianList;

        try {
            pembelianList = this.jdbcTemplate.query("SELECT * FROM pembelian WHERE id LIKE ? AND id_pengguna = ? LIMIT ? OFFSET ?",
                    preparedStatement -> {
                        preparedStatement.setString(1, "%" + id + "%");
                        preparedStatement.setString(2, idCustomer);
    ...
    @Override
    public List<Pembelian> findByDate(LocalDate date, String idCustomer, int limit, int offset) {
        List<Pembelian> pembelianList;

        try {
            pembelianList = this.jdbcTemplate.query("SELECT * FROM pembelian WHERE tanggal = ? AND id_pengguna = ? LIMIT ? OFFSET ?",
                    preparedStatement -> {
                        preparedStatement.setString(1, date.toString());
                        preparedStatement.setString(2, idCustomer);
                        preparedStatement.setInt(3, limit);
    ...
    @Override
    public List<Pembelian> findByFilm(String judul, String idCustomer, int limit, int offset) {
        List<Pembelian> pembelianList;

        try {
            pembelianList = this.jdbcTemplate.query("SELECT p.id, p.jumlah_tiket, p.total, p.tanggal FROM pembelian p, jadwal j, film f WHERE p.id_jadwal = j.id AND j.id_film = f.id AND p.id_pengguna = ? AND f.judul LIKE ? LIMIT ? OFFSET ?;",
                    preparedStatement -> {
                        preparedStatement.setString(1, idCustomer);
                        preparedStatement.setString(2, "%" + judul + "%");
                        preparedStatement.setInt(3, limit);
